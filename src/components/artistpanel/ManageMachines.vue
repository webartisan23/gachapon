            ...
            >
              <form class="w-100">
                <div class="form-group">
                  <label class="text-uppercase">Machine name</label>
                  <input
                    type="text"
                    class="form-control"
                    value="Death machine"
                ...
                <div class="form-group">
                  <label class="text-uppercase">Machine Description</label>
                  <textarea
                    name=""
                    id=""
                    cols="30"
                    ...
                    class="form-control"
                  >
Get the carziest looking</textarea
                  >
